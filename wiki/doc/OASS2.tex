...
\item Ease  of  advertisement:  Ideally the software helps the advertiser to optimize its advertisements (e.g. by helping adding relevant metaï¿½data).
...
\item User experience: Ensuring that the user experience is stateï¿½ofï¿½theï¿½art. This includes a graphically appealing interface for the player, fast response times and good availability. Alternative online casinos are only a click away when the user is upset.
