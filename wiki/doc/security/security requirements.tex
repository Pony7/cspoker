...
To reduce the workload and the documentation, only a cohesive selection of components will be secured. The DFD for the simplified version can be found in figure \ref{fig:dfd_level_0_player_simplified}. This means following components will be omitted for future analysis: Cashier, Lobby and Chat Service. Although some of these components will benefit from the instantiated patterns, potential conflicts could arise if the omitted components would be secured in a future phase.
...
We will use the security patterns and methodology described in \cite{150002} to select the appropriate patterns
...
As stated in \cite[p13]{15000}, the architecture of the system is designed using ADD or Attribute-Driven Design,
