...
From the business goals identified in the initial architecture, the following important quality attributes are selected:  \textbf{usability}, \textbf{security} and \textbf{availability}. The overview of the quality attribute tree can be found in table \ref{QAT}. In the following sections the rationale for choosing the importance (business perspective) and difficulty (technical perspective) ratings are elaborated.
\begin{table}[htpb]
\begin{center}
\begin{tabular}{| p{2,2cm} | p{0.35cm} | p{4cm} | p{0.65cm} | p{5cm} | p{0,35cm} | p{0,35cm} | }
\hline
\textbf{Level 2: Quality Attribute} & \multicolumn{2}{p{4.3cm}|}{\textbf{Level 3: Quality Attribute Refinement}} & \multicolumn{2}{p{5.4cm}|}{\textbf{Level 4: Quality Attribute Scenario}} & \textbf{I} & \textbf{D}\\
\hline
\hline
\textbf{Availability} 	& A1 & Prevention 	& A1.1 & Network failure occurence & H & M   \\\cline{4-7}
			& &			& A1.2 & Hardware failure occurence & H & M  \\\cline{2-7}
			& A2 & Fault detection 	& A2.1 & Detection of network failure & M & M  \\\cline{4-7}
			& &			& A2.2 & Detection of hardware failure & M & M  \\\cline{2-7}
			& A3 & Recovery 	& A3.1 & Network failure recovery & M & H  \\\cline{4-7}
			& &			& A3.2 & Hardware failure recovery & M & H  \\\hline
\textbf{Security} 	& S1 & Authentication 	& S1.1 & 99.999\% of all users are correctly authenticated & H & M   \\\cline{2-7}
			...
			& S3 & Storage Confidentiality & S3.1 & All account related data are secure 99.999\% of time & H & L   \\\cline{2-7}
			& S4 & Transmission Confidentiality & S4.1 & Cards are transmitted secure 99.999\% of time & M & L  \\\cline{2-7}
			& S5 & Transmission Integrity & S5.1 & 99.999\% of all transmitted cards remain unmodified & M & L  \\\cline{4-7}
			& &			& S5.2 & 99.999\% of all transmitted actions remain unmodified & M & L  \\\cline{2-7}
			& S6 & Auditing 		& S6.1 & 99.999\% of actions are logged and kept for 2 years & L & L  \\\hline
\textbf{Usability} 	& &			&  &User must be able so seat within 3 clicks & L & L  \\\cline{4-7}
			& &			&  &User must be able to find the correct button within 2 seconds & H & L  \\\cline{4-7}
			& &			&  &User must be able to define default actions & M & L  \\\cline{4-7}
			& &			&  &The user interface must respond to an action within 500ms & H & M  \\\cline{4-7}
			& &			&  &The user interface must be separated to enable easy testing & M & M  \\\hline
