...
The tradeoff column in the quality attribute scenarios is difficult to fill in. Essentially, every architactural decision will have some impact on other attributes, even if it is cost. Every architectural decision should have an entry in this column, which makes it rather useless.
