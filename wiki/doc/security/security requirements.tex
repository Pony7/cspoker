...
So Secure Access Layer and Secure Pipe are selected and instantiated to deal with the Data Integrity requirement.
...
Load Balancer has as label +Performance, and benefits from Replicated System and Session Failover, it impairs 
Session.

Replicated System has as labels -Manageability and -Cost, and depends on Load Balancer.
...
We can now consider the Availability requirement as resolved.
