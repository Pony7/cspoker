...
\begin{table}[htpb]
\begin{center}
\begin{tabular}{| p{2,5cm} | p{4cm} | p{5cm} | p{0,4cm} | p{0,4cm} | p{0,4cm} |}
\hline
...
\textbf{Security} & Authentication & 99.999\% of all users are correctly authenticated & & &  \\\cline{2-6}
& Authorization & 99.999\% of all users are correctly authorized  & H & M & H \\\cline{2-6}
& Storage Confidentiality & All account related data are secure 99.999\% of time & H & L & L  \\\cline{2-6}
& Transmission Confidentiality & Cards are transmitted secure 99.999\% of time & M & L & L \\\cline{2-6}
& Transmission Integrity & 99.999\% of all transmitted cards remain unmodified &  &  &  \\\cline{3-6}
& & 99.999\% of all transmitted actions remain unmodified &  &  &  \\\cline{2-6}
& Auditing & 99.999\% of actions are logged and kept for 2 years & L & L & L \\\hline
...
\hline
\textbf{Scenario \#:} & \multicolumn{4}{| l |}{\textbf{Scenario:} } \\\hline
\textbf{Attribute(s)} & \multicolumn{4}{| l |}{attribute} \\\hline
\textbf{Environment} & \multicolumn{4}{| l |}{environment} \\\hline
\textbf{Stimulus} & \multicolumn{4}{| l |}{stimulus} \\\hline
\textbf{Response} & \multicolumn{4}{| l |}{response} \\\hline \hline
...
\textbf{Reasoning} & \multicolumn{4}{| l |}{reasoning} \\\hline
\textbf{Architecture diagram} & \multicolumn{4}{| l |}{None} \\\hline
\end{tabular}
