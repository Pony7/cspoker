...
\begin{itemize}
\item we could select more quality attributes and elaborate more scenario's when doing the ATAM. Performance would have been a good choice. This would have given a more complete view on the impact of all the architectural decisions.
\end{itemize}
