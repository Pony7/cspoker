...
\item \textbf{Publish-Subscribe + Message Queuing:} Interested clients can register themselves to receive specific events from the server. If the message can not be sent immediately the event is queued.
\end{itemize}
