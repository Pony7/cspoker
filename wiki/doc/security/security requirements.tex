...
\textbf{Summary:} \\
The mis-actor gains access to the account management system or manages to pretend he is the account management system by obtaining or falsifying credentials. By doing so the mis-actor gains control over how incoming requests and data are processed. He can for instance trick other processes in to accepting bad credentials for authentication.
