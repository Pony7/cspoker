...
\begin{table}[htpb]
\begin{center}
\begin{tabular}{| p{2,2cm} | p{0.35cm} | p{2.5cm} | p{0.65cm} | p{6cm} | p{0,31cm} | p{0,31cm} | }
\hline
\textbf{Level 2:\newline Quality Attribute} & \multicolumn{2}{p{2.85cm}|}{\textbf{Level 3:\newline Quality Attribute Refinement}} & \multicolumn{2}{p{6.65cm}|}{\textbf{Level 4:\newline Quality Attribute Scenario}} & \textbf{I} & \textbf{D}\\
\hline
\hline
\textbf{Availability} 	& A1 & Prevention 	& A1.1 & The MTBF of all the hardware is at least 5 years. & H & M   \\\cline{4-7}
			...
			& A2 & Fault\newline detection 	& A2.2 & Server hardware failure is detected within 20s. & M & M  \\\cline{4-7}
			& &			& A2.1 & Network failure is detected within 5s. & M & M  \\\cline{2-7}
			& A3 & Recovery 	& A3.2 & Recovery from server hardware failure takes 50s and succeeds 99.99\% of the time. & M & H  \\\cline{4-7}
			& &			& A3.1 & Recovery from a network failure takes 30s and succeeds 99.99\% of the time. & M & H  \\\hline
