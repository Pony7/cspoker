...
\item The mis-actor can take actions with this fake identity.
\end{itemize}
...
DoS against the poker server & Load balancer, Application Firewall, Firewall, Audit interceptor, Secure logger\\\hline
...
\textbf{Table} & \\\hline
Spoofing a table & \\\hline
Tampering with a table & \\\hline
Repudiation of an action at a table & \\\hline
Information disclosure at a table & \\\hline
DoS against a table & \\\hline
Elevation of privilege at a table & \\\hline
\end{tabular}
\end{center}
...
Spoofing the account management system & \\\hline
Tampering with the account management system & \\\hline
Repudiation of using the account management system & \\\hline
Information disclosure of the account management system & \\\hline
DoS against the account management system & \\\hline
Elevation of privilege at the account management system & \\\hline
\textbf{Logging Engine} & \\\hline
Spoofing the logging engine & \\\hline
Tampering with the logging engine & \\\hline
Repudiation of using the logging engine & \\\hline
Information disclosure at the logging engine & \\\hline
\textbf{Audit Log} & \\\hline
Tampering with the audit log & \\\hline
Repudiation of logging something in the audit log & \\\hline
Information disclosure of the audit log & \\\hline
DoS against the audit log & \\\hline
\textbf{Account Data} & \\\hline
Tampering with account data & \\\hline
Information disclosure of account data & \\\hline
DoS against account data & \\\hline
\end{tabular}
\end{center}
