...
\textbf{Security} & S1 Authentication & S1.1 99.999\% of all users are correctly authenticated & & &  \\\cline{2-6}
...
& S5 Transmission Integrity & S5.1 99.999\% of all transmitted cards remain unmodified &  &  &  \\\cline{3-6}
& & S5.2 99.999\% of all transmitted actions remain unmodified &  &  &  \\\cline{2-6}
