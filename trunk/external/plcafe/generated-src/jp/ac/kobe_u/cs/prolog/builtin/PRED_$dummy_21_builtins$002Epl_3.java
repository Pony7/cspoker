...
/**
 ...
 @version 1.0
*/
class PRED_$dummy_21_builtins$002Epl_3 extends Predicate {
    ...
    public PRED_$dummy_21_builtins$002Epl_3(Term a1, Term a2, Term a3, Predicate cont) {
        arg1 = a1;
        arg2 = a2;
        arg3 = a3;
        this.cont = cont;
    ...
    public String toString() {
        return "$dummy_21_builtins.pl(" + arg1 + "," + arg2 + "," + arg3 + ")";
    }
...
class PRED_$dummy_21_builtins$002Epl_3_1 extends PRED_$dummy_21_builtins$002Epl_3 {
    public Predicate exec(Prolog engine) {
    // '$dummy_21_builtins.pl'(A,B,C):-number_codes(C,A),!,B=C
        Term a1, a2, a3, a4;
        Predicate p1, p2;
        Predicate cont;
        a1 = engine.aregs[1];
        ...
        a3 = engine.aregs[3];
        cont = engine.cont;
    // '$dummy_21_builtins.pl'(A,B,C):-['$get_level'(D),number_codes(C,A),'$cut'(D),'$unify'(B,C)]
        ...
        p1 = new PRED_$unify_2(a2, a3, cont);
        p2 = new PRED_$cut_1(a4, p1);
        return new PRED_number_codes_2(a3, a1, p2);
    }
}

class PRED_$dummy_21_builtins$002Epl_3_2 extends PRED_$dummy_21_builtins$002Epl_3 {
    public Predicate exec(Prolog engine) {
    // '$dummy_21_builtins.pl'(A,B,C):-'$dummy_22_builtins.pl'(C,A,B)
        Term a1, a2, a3;
        Predicate cont;
        a1 = engine.aregs[1];
        a2 = engine.aregs[2];
        ...
        cont = engine.cont;
    // '$dummy_21_builtins.pl'(A,B,C):-['$dummy_22_builtins.pl'(C,A,B)]
        return new PRED_$dummy_22_builtins$002Epl_3(a3, a1, a2, cont);
    }
}
