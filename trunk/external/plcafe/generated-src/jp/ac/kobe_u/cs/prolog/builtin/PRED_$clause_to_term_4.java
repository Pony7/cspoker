...
/**
 ...
 @version 1.0
*/
class PRED_$clause_to_term_4 extends Predicate {
    ...
    public PRED_$clause_to_term_4(Term a1, Term a2, Term a3, Term a4, Predicate cont) {
        arg1 = a1;
        arg2 = a2;
        arg3 = a3;
        arg4 = a4;
    ...
    public String toString() {
        return "$clause_to_term(" + arg1 + "," + arg2 + "," + arg3 + "," + arg4 + ")";
    }
    ...
    // '$clause_to_term'(A,B,C:D/E,F):-['$clause_to_term'(A,B,user,C,F),'$unify'(B,(G:-H)),functor(G,D,E)]
        ...
        return new PRED_$clause_to_term_5(a1, a2, s3, a5, a4, p2);
    }
}
