...
public class SyntaxException extends BuiltinException {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6165851056735045978L;

	/** A functor symbol of <code>syntax_error/5</code>. */
	public static SymbolTerm SYNTAX_ERROR = SymbolTerm.makeSymbol(
			"syntax_error", 5);
	...
	/**
	 * Constructs a new <code>SyntaxException</code> with a valid type, its
	 * culprit, and message.
	 */
	...
	public SyntaxException(Predicate _goal, int _argNo, String _type,
