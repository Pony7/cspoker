...
public class VariableTerm extends Term implements Undoable {
	...
	private static final long serialVersionUID = 854395072317158464L;
	...
	/**
	 * Constructs a new logical variable so that the <code>timeStamp</code>
	 * field is set to <code>Long.MIN_VALUE</code>.
	 */
	public VariableTerm() {
		val = this;
	...
	/**
	 * Constructs a new logical variable so that the <code>timeStamp</code>
	 * field is set to the current value of <code>CPFTimeStamp</code> of the
	 * specified Prolog engine.
	 * 
	 * @param engine
	...
	/**
	 * Binds this variable to a given term. And pushs this variable to trail
	 * stack if necessary.
	 * 
	 * @param t
	 *            a term to be bound.
	...
	public final void bind(Term t, Trail trail) {
		...
		if (t.isVariable()
				&& (variableTerm = (VariableTerm) t).timeStamp() >= timeStamp) {
			variableTerm.val = this;
			if (variableTerm.timeStamp() < trail.engine.stack.getTimeStamp()) {
				trail.add(variableTerm);
			}
		} else {
			val = t;
	 ...
	 * if this variable is unbound. Otherwise, returns the value of
	 * <code>val.convertible(type)</code>.
	 * 
	 * @param type
	 *            the Java class type to compare with.
	 * @return <code>true</code> if this (or dereferenced term) is convertible
	 *         with <code>type</code>. Otherwise <code>false</code>.
	 * @see #val
	 */
	@Override
	...
	/**
	 * Returns <code>this</code> if this variable is unbound. Otherwise, returns
	 * a Java object that corresponds to the dereferenced term:
	 * <code>val.toJava()</code>.
	 * 
	 * @return a Java object defined in
	 ...
	 * @return <code>true</code> if this (or dereferenced term) is the same as
	...
	/**
	 * Returns a string representation of this term if unbound. Otherwise,
	 * returns the value of dereferenced term: <code>val.toString()</code>
	 * 
	 * @see #val
	 */
	@Override
