...
public abstract class NumberTerm extends Term {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 5576236097785871978L;
	 ...
	 * @return the value <code>0</code> if this object is numerically equal to
	 *         the argument <code>NumberTerm</code>; a value less than
	 *         <code>0</code> if this object is numerically less than the
	 *         argument <code>NumberTerm</code>; and a value greater than
	 *         <code>0</code> if this object is numerically greater than the
	 *         argument <code>NumberTerm</code>.
	 */
	...
	/**
	 * Returns a <code>NumberTerm</code> whose value is the float-integer-part
	 * of <code>this</code>.
	 */
	abstract public NumberTerm floatIntPart();

	/**
	 * Returns a <code>NumberTerm</code> whose value is the
	 * float-fractional-part of <code>this</code>.
	 */
