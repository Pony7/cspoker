 ...
 *<ul>
 *<li>The alphanumeric characters &ldquo;<code>a</code>&rdquo; through &ldquo;
 * <code>z</code>&rdquo;, &ldquo;<code>A</code>&rdquo; through &ldquo;
 * <code>Z</code>&rdquo; and &ldquo;<code>0</code>&rdquo; through &ldquo;
 * <code>9</code>&rdquo; remain the same.
 *<li>The special characters &ldquo;<code>_</code>&rdquo; and &ldquo;
 * <code>$</code>&rdquo; remain the same.
 *<li>All other characters are first converted into a list of character codes.
 * Then each character code is represented by the 5-character string &ldquo;
 * <code>$XYZW</code>&rdquo;, where <code>XYZW</code> is the four-digit
...
public class PredicateEncoder {
	 ...
	 * @param arity
	 *            predicate arity
	 * @return a string representation of class for the predicate that
	 *         corresponds to <code>pkg:functor/arity</code>.
	 */
	public static String encode(String pkg, String functor, int arity) {
		...
		while (result) {
			// m.appendReplacement(sb, String.format("\\$%2X",
			// (int)(m.group().charAt(0))));
			m.appendReplacement(sb, String.format("\\$%04X", (int) m.group()
					.charAt(0)));
			result = m.find();
		}
		m.appendTail(sb);
	...
	/**
	 * Returns a <code>java.lang.Class</code> object associated with the
	 * predicate class with the given arguments.
	 * 
	 * @param pkg
	 *            package name
	 * @param functor
	 ...
	 * @param arity
	 *            predicate arity
	 * @return a <code>java.lang.Class</code> object associated with the
	 *         predicate class that corresponds to
	 *         <code>pkg:functor/arity</code> if exists, otherwise
	 *         <code>null</code>.
	 * @deprecated As of Prolog Cafe 1.1, replaced by
	 *             {@link PrologClassLoader#loadPredicateClass(String,String,int,boolean)}
	 *             ;
	 */
	@Deprecated
	 ...
	 * @deprecated As of Prolog Cafe 1.1, replaced by
	 *             {@link PrologClassLoader#definedPredicate(String,String,int)}
	 *             ;
	 */
	@Deprecated
