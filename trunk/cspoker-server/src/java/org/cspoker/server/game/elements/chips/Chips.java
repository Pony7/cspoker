...
package org.cspoker.server.game.elements.chips;
...
public class Chips {
     ...
     *                 [must] The given initial value is not a legal value for
     *                 the chips. | !canHaveAsValue(initalValue)
     */
     ...
     *       value
     * @throws IllegalValueException
     *                 [must] The given value is not a legal value for the
     *                 chips. | !canHaveAsValue(value)
     */
     ...
     * 
     * @param amount
     *                The amount to increase the value of the pile of chips
     *                with.
     ...
     * 
     * @param amount
     *                The amount to decrease the value of the pile of chips
     *                with.
     * @pre The amount should be positive. |amount>=0
     ...
     * @throws IllegalValueException
     *                 [must] This pile of chips can not have the new value as
     *                 its value. | !canHaveAsValue(new.getValue())
     * @throws IllegalValueException
     *                 [must] This given pile of chips can not have the new
     *                 value as its value. |
