...
public class Deck {
	...
	/**
	 * Returns a list of Cards removed from the deck. This method is not thread-safe. Since the deck is modified, it is important to synchronize on
	 * the deck in multi-threaded programs.
	 * 
	 * @param number
	...
	public List<Card> deal(final int number) {
		...
		final List<Card> handView = this.cards.subList(deckSize - number, deckSize);
