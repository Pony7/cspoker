...
import org.cspoker.common.api.chat.context.ExternalChatContext;
import org.cspoker.common.api.lobby.context.ExternalLobbyContext;

public interface ExternalServerContext extends RemoteServerContext{

	AccountContext getAccountContext();
	
	CashierContext getCashierContext();
	
	ExternalChatContext getChatContext();

	ExternalLobbyContext getLobbyContext();
