...
public class ForwardingHoldemPlayerListener extends ForwardingListener<HoldemPlayerListener> implements HoldemPlayerListener {

	public ForwardingHoldemPlayerListener() {
		super();
	}
	
	public ForwardingHoldemPlayerListener(List<HoldemPlayerListener> listeners) {
		super(listeners);
	}
