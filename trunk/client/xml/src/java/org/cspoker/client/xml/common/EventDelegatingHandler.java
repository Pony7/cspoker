...
public class EventDelegatingHandler extends DelegatingHandler implements
	...
	public ContentHandler getHandler(String uri, String localName, String name,
		...
		throw new SAXException(
				new IllegalArgumentException("Illegal tag name."));
	}

	private void notifyOfIllegalAction(IllegalActionException e)
	...
	private class CreatetableHandler extends DefaultHandler {
		...
		public CreatetableHandler(Attributes attrs)
	...
	private class LeavetableHandler extends DefaultHandler {
		...
		public LeavetableHandler(Attributes attrs)
				throws IllegalActionException {
