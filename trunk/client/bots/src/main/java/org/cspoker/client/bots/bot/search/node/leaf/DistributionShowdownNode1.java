...
public class DistributionShowdownNode1 extends AbstractShowdownNode{

	private final static Logger logger = Logger.getLogger(DistributionShowdownNode1.class);
	...
	public String toString() {
		return "Distribution Showdown Node v1";
	}
	...
	public static class Factory implements AbstractShowdownNode.Factory{
		...
		@Override
		public String toString() {
			return "Distribution Showdown Node v1 factory";
		}
	}
