...
public abstract class ToPrologTermVisitor extends LoggingVisitor {
	...
	//predicate terms
	public final static SymbolTerm game_round_start = SymbolTerm.makeSymbol("game_round_start", 4);
	public final static SymbolTerm game_player_action = SymbolTerm.makeSymbol("game_player_action", 6);
	public final static SymbolTerm game_player_big_blind = SymbolTerm.makeSymbol("game_player_big_blind",2);
	public final static SymbolTerm game_player_small_blind = SymbolTerm.makeSymbol("game_player_small_blind",2);
	public final static SymbolTerm game_river = SymbolTerm.makeSymbol("game_river",2);
	public final static SymbolTerm game_turn = SymbolTerm.makeSymbol("game_round_start",2);
	public final static SymbolTerm game_flop_1 = SymbolTerm.makeSymbol("game_flop_1",2);
	public final static SymbolTerm game_flop_2 = SymbolTerm.makeSymbol("game_flop_2",2);
	public final static SymbolTerm game_flop_3 = SymbolTerm.makeSymbol("game_flop_3",2);
	public final static SymbolTerm game_player_stack = SymbolTerm.makeSymbol("game_player_stack",3);
	public final static SymbolTerm game_player_seat = SymbolTerm.makeSymbol("game_player_seat",3);
	public final static SymbolTerm game_player_hole_card_1 = SymbolTerm.makeSymbol("game_player_hole_card_1",3);
	public final static SymbolTerm game_player_hole_card_2 = SymbolTerm.makeSymbol("game_player_hole_card_2",3);
	public final static SymbolTerm game_phase_start = SymbolTerm.makeSymbol("game_phase_start",3);
	public final static SymbolTerm game_player_profit = SymbolTerm.makeSymbol("game_player_profit",3);
	public final static SymbolTerm game_stakes = SymbolTerm.makeSymbol("game_stakes",3);
	public final static SymbolTerm game_session = SymbolTerm.makeSymbol("game_session",2);
	...
	protected void gamePlayerAction(AllInState allInState, PlayerId playerId) {
		addTerm(new StructureTerm(
				...
				new Term[]{
						...
						new StructureTerm(allin,new Term[]{new IntegerTerm(allInState.getEvent().getAmount())}),
						new IntegerTerm(allInState.getPreviousGameState().getDeficit(playerId)),
	...
	protected void gamePlayerAction(BetState betState, PlayerId playerId) {
		addTerm(new StructureTerm(
				...
				new Term[]{
						...
						getIncrementedActionIdTerm(),
						getPlayerTerm(playerId),
						new StructureTerm(bets,new Term[]{new IntegerTerm(betState.getEvent().getAmount())}),
						new IntegerTerm(betState.getPreviousGameState().getDeficit(playerId)),
	...
	protected void gamePlayerAction(CallState callState, PlayerId playerId) {
		...
		addTerm(new StructureTerm(
				...
				new Term[]{
						...
						getIncrementedActionIdTerm(),
						getPlayerTerm(playerId),
						new StructureTerm(calls,new Term[]{new IntegerTerm(callState.getPreviousGameState().getDeficit(playerId))}),
						new IntegerTerm(callState.getPreviousGameState().getDeficit(playerId)),
	...
	protected void gamePlayerAction(FoldState foldState, PlayerId playerId) {
		addTerm(new StructureTerm(
				...
				new Term[]{
						...
						getPlayerTerm(playerId),
						folds,
						new IntegerTerm(foldState.getPreviousGameState().getDeficit(playerId)),
		...
		addTerm(new StructureTerm(
				...
				new Term[]{
						...
						new StructureTerm(raises,
								new Term[]{
								new IntegerTerm(raiseState.getEvent().getAmount()), 
								new IntegerTerm(raiseState.getEvent().getMovedAmount())}
						),
						new IntegerTerm(raiseState.getPreviousGameState().getDeficit(playerId)),
	...
	protected void gameFlop(int cardNumber, Card card) {
		...
		if(cardNumber==1){
			...
			term = game_flop_1;
		}else throw new IllegalArgumentException("Unknown card number: "+cardNumber);
		addTerm(new StructureTerm(
				term,
				new Term[]{
						getGameIdTerm(),
	...
	protected void gamePlayerStack(PlayerState player) {		
		addTerm(new StructureTerm(
				...
				new Term[]{
						getGameIdTerm(),
						getPlayerTerm(player.getPlayerId()),
	...
	protected void gamePlayerHoleCards(int cardNumber, ShowdownPlayer showdownPlayer, Card card) {
		SymbolTerm term;
		if(cardNumber==1){
		...
		addTerm(new StructureTerm(
				...
				new Term[]{
						getGameIdTerm(),
						getPlayerTerm(showdownPlayer.getId()),
						getCardTerm(card),
				}));
	}
