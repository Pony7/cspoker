...
public class PokersourceConnection extends RESTConnection{
	...
	private final static ImmutableMap<String, Class<? extends JSONPacket>> eventTypes = 
		...
		.put(BestCards.getStaticType(), BestCards.class)
		.put(Showdown.getStaticType(), Showdown.class)
		.put(ChipsPot2Player.getStaticType(), ChipsPot2Player.class)
		.put(ChipsPotMerge.getStaticType(), ChipsPotMerge.class)
		.put(TimeoutWarning.getStaticType(), TimeoutWarning.class)
		.build();
}
