...
import org.cspoker.client.bots.bot.gametree.rollout.rankdistribution.ShowdownRankPredictor1of4;
import org.cspoker.client.bots.bot.gametree.rollout.rankdistribution.ShowdownRankPredictor2of4;
import org.cspoker.client.bots.bot.gametree.rollout.rankdistribution.ShowdownRankPredictor3of4;
import org.cspoker.client.bots.bot.gametree.rollout.rankdistribution.ShowdownRankPredictor4of4;
...
public class DistributionRollout4 extends AbstractDistributionRollout {
	...
	public static class Factory implements AbstractDistributionRollout.Factory{
		...
		@Override
		public DistributionRollout4 create(GameState gameState,
				PlayerId botId) {
