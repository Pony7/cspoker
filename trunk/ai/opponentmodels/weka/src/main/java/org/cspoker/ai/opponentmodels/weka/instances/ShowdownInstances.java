...
public class ShowdownInstances extends InstancesBuilder{
	...
	private final static String attributes = 
		"@attribute gameCount integer"+nl+
		"@attribute potSize real"+nl+
		"@attribute logPotSize real"+nl+
		"@attribute stackSize real"+nl+
		"@attribute log1pStackSize real"+nl+
		"@attribute nbSeatedPlayers integer"+nl+
		"@attribute nbActivePlayers integer"+nl+
		"@attribute activePlayerRatio real"+nl+
		"@attribute betFrequency real"+nl+
		"@attribute foldFrequency real"+nl+
		"@attribute callFrequency real"+nl+
		"@attribute raiseFrequency real"+nl+
		"@attribute nbAllPlayerBetRaise integer"+nl+
		"@attribute nbPlayerBetRaise integer"+nl+
		"@attribute nbPlayerPreFlopBetRaise integer"+nl+
		"@attribute nbPlayerPostFlopBetRaise integer"+nl+
		"@attribute nbPlayerFlopBetRaise integer"+nl+
		"@attribute nbPlayerTurnBetRaise integer"+nl+
		"@attribute nbPlayerRiverBetRaise integer"+nl+
		"@attribute allPlayerBetRaiseAmount integer"+nl+
		"@attribute playerBetRaiseAmount integer"+nl+
		"@attribute playerPreFlopBetRaiseAmount integer"+nl+
		"@attribute playerPostFlopBetRaiseAmount integer"+nl+
		"@attribute playerFlopBetRaiseAmount integer"+nl+
		"@attribute playerTurnBetRaiseAmount integer"+nl+
		"@attribute playerRiverBetRaiseAmount integer"+nl+
		"@attribute allPlayerBetsAmount integer"+nl+
		"@attribute playerBetsAmount integer"+nl+
		"@attribute playerPreFlopBetsAmount integer"+nl+
		"@attribute playerPostFlopBetsAmount integer"+nl+
		"@attribute playerFlopBetsAmount integer"+nl+
		"@attribute playerTuretsAmount integer"+nl+
		"@attribute playerRiverBetsAmount integer"+nl+
		"@attribute allPlayerRaisesAmount integer"+nl+
		"@attribute playerRaisesAmount integer"+nl+
		"@attribute playerPreFlopRaisesAmount integer"+nl+
		"@attribute playerPostFlopRaisesAmount integer"+nl+
		"@attribute playerFlopRaisesAmount integer"+nl+
		"@attribute playerTurnRaisesAmount integer"+nl+
		"@attribute playerRiverRaisesAmount integer"+nl+
		"@attribute relNbPlayerBetRaise integer"+nl+
		"@attribute relNbPlayerPreFlopBetRaise integer"+nl+
		"@attribute relNbPlayerPostFlopBetRaise integer"+nl+
		"@attribute relNbPlayerFlopBetRaise integer"+nl+
		"@attribute relNbPlayerTurnBetRaise integer"+nl+
		"@attribute relNbPlayerRiverBetRaise integer"+nl+
		"@attribute relPlayerBetRaiseAmount integer"+nl+
		"@attribute relPlayerPreFlopBetRaiseAmount integer"+nl+
		"@attribute relPlayerPostFlopBetRaiseAmount integer"+nl+
		"@attribute relPlayerFlopBetRaiseAmount integer"+nl+
		"@attribute relPlayerTurnBetRaiseAmount integer"+nl+
		"@attribute relPlayerRiverBetRaiseAmount integer"+nl+
		"@attribute nbPlayerPreFlopBetRaiseTable integer"+nl+
		"@attribute nbPlayerPostFlopBetRaiseTable integer"+nl+
		"@attribute nbPlayerFlopBetRaiseTable integer"+nl+
		"@attribute nbPlayerTurnBetRaiseTable integer"+nl+
		"@attribute nbPlayerRiverBetRaiseTable integer"+nl+
		"@attribute playerPreFlopBetRaiseAmountTable integer"+nl+
		"@attribute playerPostFlopBetRaiseAmountTable integer"+nl+
		"@attribute playerFlopBetRaiseAmountTable integer"+nl+
		"@attribute playerTurnBetRaiseAmountTable integer"+nl+
		"@attribute playerRiverBetRaiseAmountTable integer"+nl+
		"@attribute lastActionWasBetRaise {false,true}"+nl+
		"@attribute VPIP real"+nl+
		"@attribute PFR real"+nl+
		"@attribute AF real"+nl+
		"@attribute AFq real"+nl+
		"@attribute logAFAmount real"+nl+
		"@attribute WtSD real"+nl+
		"@attribute opponentVPIP real"+nl+
		"@attribute opponentPFR real"+nl+
		"@attribute opponentAF real"+nl+
		"@attribute opponentAFq real"+nl+
		"@attribute opponentLogAFAmount real"+nl+
		"@attribute opponentWtSD real"+nl;
