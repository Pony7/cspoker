...
public class WekaRegressionModelFactory implements OpponentModel.Factory {
	...
	public static WekaRegressionModelFactory createForZip(boolean overwrite, String zippedModel) throws IOException, ClassNotFoundException {
		...
		return new WekaRegressionModelFactory(overwrite, classifiers.get("preBet.model"), classifiers.get("preFold.model"), classifiers.get("preCall.model"), classifiers.get("preRaise.model"), classifiers.get("postBet.model"), classifiers.get("postFold.model"), classifiers.get("postCall.model"), classifiers.get("postRaise.model"),
	...
	public static WekaRegressionModelFactory createForDir(boolean overwrite, String models) throws IOException, ClassNotFoundException {
		...
		in.close();
		return new WekaRegressionModelFactory(overwrite, preBetModel, preFoldModel, preCallModel, preRaiseModel, postBetModel, postFoldModel, postCallModel, postRaiseModel,
				showdown0Model, showdown1Model, showdown2Model, showdown3Model, showdown4Model, showdown5Model);
	}
	...
	public OpponentModel create() {
		return new WekaRegressionModel(overwrite, preBetModel, preFoldModel, preCallModel, preRaiseModel, postBetModel, postFoldModel, postCallModel, postRaiseModel,
				showdown0Model, showdown1Model, showdown2Model, showdown3Model, showdown4Model, showdown5Model);
	}
