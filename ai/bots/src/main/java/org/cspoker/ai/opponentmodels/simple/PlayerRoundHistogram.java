...
public class PlayerRoundHistogram {
	...
	public PlayerRoundHistogram(int nbCheck, int nbBet, int totalNoBet, int nbFold,
			int nbCall, int nbRaise, int totalBet) {
	...
	public Pair<Double, Double> getCheckBetProbabilities(GameState gameState,
			PlayerId actor) {
		return new Pair<Double, Double>(getCheckProbability(gameState),
