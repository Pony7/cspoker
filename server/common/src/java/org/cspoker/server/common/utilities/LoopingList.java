...
package org.cspoker.server.common.utilities;
...
/**
 * A class to represent a looping list. If the end of the list is reached, it
 * wraps back to the first element.
 * 
 * @author Kenzo
 * 
 * @param <T>
 *                The type of the elements in this looping list.
 * 
...
public class LoopingList<T> {
    ...
    /**
     * Construct a new looping list from given list. There is no dependence
     * between the given list and this looping list.
     * 
     * @param list
     *                The list to make a looping list with.
     * @pre The given list should be effective. |list!=null
     * @pre The list should contain at least 1 element. |list.size()>0
     * @pre Every element in the given list should be unique.
     * @post The first element of the given list is initialized as the first
     *       element of the looping list. |list.get(0)==new.getCurrent()
     ...
     * @post If the given element is an element of this looping list, the
     *       current element is set to the given element, else the current
     *       element remains the same. |if(contains(o)) | then o==null ?
     *       new.getCurrent()==null : new.getCurrent().equals(o) | else
     *       getCurrent()==new.getCurrent()
     */
    ...
    /**
     * Returns the element next to the given element in this looping list.
     * 
     * @param o
     *                The element for which the next element should be returned.
     * @return The element next to the given element in this looping list.
     ...
     *         otherwise. | result == contains(o)
     * @post If the given element is present in this looping list, the given
     *       element is removed from this list. After deletion, whether the
     *       given element is contained or not, there is no more instance of the
     *       given element present in the list. |!new.contains(o)
     * @post If the current element is removed, the current element will be set
    ...
    /**
     * Returns an unmodifiable list, containing all elements of this looping
     * list.
     * 
     * The current element of the looping list does not necessarily correspond
     * to the first element of the returned list.
     * 
