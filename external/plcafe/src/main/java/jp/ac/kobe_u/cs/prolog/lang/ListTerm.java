...
public class ListTerm extends Term {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -7463387292236692342L;

	/** A functor <code>'.' /2</code>. */
	protected final static SymbolTerm SYM_DOT = SymbolTerm.makeSymbol(".", 2);
	 ...
	 * first element of this list, and <code>_cdr</code> is the list consisting
	 * of all the rest of the elements of this list but the first one.
	 */
	...
	/**
	 * Returns a <code>java.util.Vector</code> corresponds to this
	 * <code>ListTerm</code> according to
	 * <em>Prolog Cafe interoperability with Java</em>.
	 * 
	 * @return a <code>java.util.Vector</code> object equivalent to this
	 ...
	 * <code>ListTerm</code>, and all corresponding pairs of elements in the two
	 * lists are <em>term-equal</em>.
	 * 
	 * @param obj
