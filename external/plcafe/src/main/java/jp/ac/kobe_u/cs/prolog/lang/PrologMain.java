...
public class PrologMain {
	...
	public static void main(String argv[]) {
		...
		try {
			...
			clazz = new PrologClassLoader()
					.loadPredicateClass("jp.ac.kobe_u.cs.prolog.builtin",
							"initialization", 2, true);
			Term arg1 = Prolog.Nil;
			arg1 = new ListTerm(SymbolTerm.makeSymbol("user"), arg1);
			arg1 = new ListTerm(SymbolTerm
					.makeSymbol("jp.ac.kobe_u.cs.prolog.builtin"), arg1);
			// arg1 = new
			// ListTerm(SymbolTerm.makeSymbol("jp.ac.kobe_u.cs.prolog.compiler.pl2am"),
			// arg1);
			// arg1 = new
			// ListTerm(SymbolTerm.makeSymbol("jp.ac.kobe_u.cs.prolog.compiler.am2j"),
			// arg1);
	 ...
	 * @return a term which corresponds to a given string, or <code>null</code>
	 *         if parsing fails.
	 */
	...
	/*
	 * public static Term makeList(int n){ Term t = SymbolTerm.makeSymbol("[]");
	 * for (int i=n; i>0; i--){ t = new ListTerm(new IntegerTerm(i), t); }
	 * return t; }
	 */
}
