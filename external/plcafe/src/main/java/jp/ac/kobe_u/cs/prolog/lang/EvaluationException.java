...
public class EvaluationException extends BuiltinException {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -1641466992467366681L;

	/** A functor symbol of <code>evaluation_error/3</code>. */
	public static SymbolTerm EVALUATION_ERROR = SymbolTerm.makeSymbol(
			"evaluation_error", 3);
	...
	/**
	 * Constructs a new <code>EvaluationException</code> with the given
	 * arguments.
	 */
