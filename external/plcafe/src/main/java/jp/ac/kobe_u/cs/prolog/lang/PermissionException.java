...
public class PermissionException extends BuiltinException {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3130686281437914210L;

	/** A functor symbol of <code>permission_error/5</code>. */
	public static SymbolTerm PERMISSION_ERROR = SymbolTerm.makeSymbol(
			"permission_error", 5);

	/*
	 * operation ::= access | create | input | modify | open | output |
	 * reposition | new
	 */
	...
	/**
	 * Constructs a new <code>PermissionException</code> with the given
	 * arguments.
	 */
	public PermissionException(Predicate _goal, String _operation,
			String _permissionType, Term _culprit, String _message) {
		goal = _goal;
	...
	public Term getMessageTerm() {
		Term[] args = { new JavaObjectTerm(goal),
				SymbolTerm.makeSymbol(operation),
				SymbolTerm.makeSymbol(permissionType), culprit,
	...
	public String toString() {
		...
		s += " - can not " + operation + " " + permissionType + " "
				+ culprit.toString();
		s += ": " + message;
		s += "}";
		return s;
