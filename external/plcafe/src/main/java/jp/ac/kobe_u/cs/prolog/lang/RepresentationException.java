...
public class RepresentationException extends BuiltinException {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 2698167667917750680L;

	/** A functor symbol of <code>representation_error/3</code>. */
	public static SymbolTerm REPRESENTATION_ERROR = SymbolTerm.makeSymbol(
			"representation_error", 3);
	 ...
	 * <code>RepresentationException</code>:
