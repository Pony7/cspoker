...
/**
 ...
 @version 1.0
*/
class PRED_$write_term_args_5 extends Predicate {
    static SymbolTerm s1 = SymbolTerm.makeSymbol("[]");
    static IntegerTerm si2 = new IntegerTerm(999);
    static SymbolTerm s3 = SymbolTerm.makeSymbol("punct");
    ...
    public PRED_$write_term_args_5(Term a1, Term a2, Term a3, Term a4, Term a5, Predicate cont) {
        arg1 = a1;
        arg2 = a2;
        arg3 = a3;
        arg4 = a4;
    ...
    public String toString() {
        return "$write_term_args(" + arg1 + "," + arg2 + "," + arg3 + "," + arg4 + "," + arg5 + ")";
    }
...
class PRED_$write_term_args_5_2 extends PRED_$write_term_args_5 {
    ...
    // '$write_term_args'([A],B,C,D,E):-['$neck_cut','$write_term0'(A,999,B,C,D,E)]
        ...
        engine.neckCut();
        //END inline expansion
        return new PRED_$write_term0_6(a6, si2, a2, a3, a4, a5, cont);
    }
}
...
class PRED_$write_term_args_5_3 extends PRED_$write_term_args_5 {
    ...
    // '$write_term_args'([A|B],C,D,E,F):-['$neck_cut','$write_term0'(A,999,C,G,E,F),'$write_space_if_needed'(G,punct,F),put_char(F,','),'$write_term_args'(B,punct,D,E,F)]
        ...
        return new PRED_$write_term0_6(a6, si2, a2, a8, a4, a5, p3);
    }
}
