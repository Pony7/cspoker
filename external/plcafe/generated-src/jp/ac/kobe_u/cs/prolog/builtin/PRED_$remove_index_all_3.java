...
/**
 ...
 @version 1.0
*/
class PRED_$remove_index_all_3 extends Predicate {
    ...
    public PRED_$remove_index_all_3(Term a1, Term a2, Term a3, Predicate cont) {
        arg1 = a1;
        arg2 = a2;
        arg3 = a3;
        this.cont = cont;
    ...
    public String toString() {
        return "$remove_index_all(" + arg1 + "," + arg2 + "," + arg3 + ")";
    }
...
class PRED_$remove_index_all_3_2 extends PRED_$remove_index_all_3 {
    ...
    // '$remove_index_all'([A|B],C,D):-['$hash_remove_first'(C,A,D),'$remove_index_all'(B,C,D)]
        ...
        return new PRED_$hash_remove_first_3(a2, a4, a3, p1);
    }
}
