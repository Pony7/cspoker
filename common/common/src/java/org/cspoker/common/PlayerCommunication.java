...
public abstract class PlayerCommunication implements RemotePlayerCommunication{
     ...
     */
    public abstract void subscribeAllEventsListener(RemoteAllEventsListener listener);
     ...
     *                The listener to subscribe.
     */
    public abstract void unsubscribeAllEventsListener(RemoteAllEventsListener listener);
