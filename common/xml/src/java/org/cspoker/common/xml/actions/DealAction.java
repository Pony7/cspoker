...
public class DealAction extends PlayerCommunicationAction<Void> {

	private static final long serialVersionUID = 6806894654949739872L;

	public DealAction(long id) {
		super(id);
	}

	protected DealAction() {
		// no op
	}
