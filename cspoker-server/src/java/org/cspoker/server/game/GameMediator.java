...
public class GameMediator implements PlayerAction {
     ...
     * 
     * Each subscribed deal listener is updated by calling their onDealEvent()
     * method.
     * 
     */
    ...
    /**
     * Inform all subscribed stack changed listeners a stack changed event has
     * occurred.
     * 
     * Each subscribed stack changed listener is updated by calling their
     * onStackChangedEvent() method.
     * 
     */
    ...
    /**
     * Inform all subscribed pot changed listeners a pot changed event has
     * occurred.
     * 
     * Each subscribed pot changed listener is updated by calling their
     * onPotChangedEvent() method.
     * 
     */
     ...
     * 
     * @param id
     *                The id of the player to get the new private cards events
     *                from.
     * @param listener
     *                The listener to subscribe.
     * 
